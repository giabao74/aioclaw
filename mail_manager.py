...
async def send_resend_email(
    ...
    # Professional plain-text footer to ensure high deliverability and compliance
    plain_text_footer = (
        "\n\n---\n"
        "AEGIX Threat Intelligence & Protection Platform\n"
        "Automated Incident Response & Customer Operations\n"
        f"Contact: {SUPPORT_EMAIL} | Website: https://aegixbot.xyz\n"
        f"To unsubscribe or update communication preferences: mailto:{SUPPORT_EMAIL}?subject=Unsubscribe"
    )
    clean_text = text.strip()
    if "AEGIX Threat Intelligence" not in clean_text:
        full_text = clean_text + plain_text_footer
    else:
...
<body style="margin:0;padding:24px;background-color:#0b0f19;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#e2e8f0;">
  <!-- Hidden Preheader for mailbox preview & text-to-code ratio -->
  <div style="display:none;font-size:1px;color:#0b0f19;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;">
    AEGIX Support Operations &bull; Official Ticket Communication Notice &bull; Security Reference ID #{secrets.token_hex(4).upper()}
  </div>
  <div style="max-width:600px;margin:0 auto;background:#111827;border:1px solid #1f2937;border-radius:14px;overflow:hidden;box-shadow:0 12px 30px rgba(0,0,0,0.5);">
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="vertical-align:middle;width:100%;">
        <tr>
          ...
          <td style="vertical-align:middle;">
            <div style="font-size:18px;font-weight:700;letter-spacing:-0.01em;color:#ffffff;line-height:1.3;">AEGIX SUPPORT TEAM</div>
    ...
    <!-- Footer -->
    <div style="padding:22px 28px;background:#090d16;border-top:1px solid #1f2937;font-size:12px;color:#64748b;line-height:1.6;">
      <div style="color:#94a3b8;font-weight:600;margin-bottom:4px;">AEGIX Threat Intelligence &amp; Protection Platform</div>
      <div>This is an official communication dispatched from AEGIX Incident Response &amp; Automated Security Systems.</div>
      <div style="margin-top:6px;">If you have any questions or require additional technical assistance, reply directly to this message or visit <a href="https://aegixbot.xyz" style="color:#38bdf8;text-decoration:none;">aegixbot.xyz</a>.</div>
      <div style="margin-top:10px;padding-top:10px;border-top:1px solid rgba(255,255,255,0.06);font-size:11px;color:#475569;">
        To manage notification settings or unsubscribe from non-critical security bulletins, you can <a href="mailto:{SUPPORT_EMAIL}?subject=Unsubscribe" style="color:#64748b;text-decoration:underline;">unsubscribe here</a>.
      </div>
    </div>
  </div>
</body>
    ...
    payload: Dict[str, Any] = {
        ...
        "html": formatted_html,
        "headers": {
            "List-Unsubscribe": f"<mailto:{SUPPORT_EMAIL}?subject=Unsubscribe>, <https://aegixbot.xyz/unsubscribe>",
            "List-Unsubscribe-Post": "List-Unsubscribe=One-Click",
            "Feedback-ID": "support-ticket:resend:aegix",
